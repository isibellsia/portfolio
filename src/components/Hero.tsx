...
export default function Hero() {
  return (
    <section className="min-h-[88vh] grid grid-cols-2 pt-20 relative overflow-hidden">
      {/* Background glow */}
      ...
      {/* Left */}
      <div className="flex flex-col justify-center px-12 pl-24 py-4 animate-fadeLeft">
        ...
        <h1 className="font-cormorant font-light leading-[1.08] text-[clamp(3.5rem,6vw,5.5rem)] text-ink mb-5">
          Izabel<br />
      ...
      {/* Right — photo */}
      <div className="flex items-center justify-center pr-24 pl-8 py-4 animate-fadeRight">
        <div className="relative w-[340px] h-[420px] group">
          {/* Decorative border */}
          ...
          <div className="relative z-10 w-full h-full bg-gradient-to-br from-sage-light via-sage to-sage-dark flex items-center justify-center">
            <img src="/profile-img.jpg" alt="Izabel Usheva" className="w-full h-full object-cover object-top" />
          </div>
      ...
      {/* Language pills */}
      <div className="absolute bottom-12 left-24 flex gap-5 animate-fadeUp">
